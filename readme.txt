=== WP Easy SMTP by Maileroo.com ===

Contributors: maileroo
...
Tags: smtp, wordpress smtp, gmail, sendgrid, mailgun, maileroo, mail, mailer, phpmailer, wp_mail, email, wp smtp
...
= Can WP Easy SMTP by Maileroo be used to send emails via Gmail, Outlook.com, Office 365, Yahoo, or other SMTP services? =

Absolutely! WP Easy SMTP by Maileroo is designed to be compatible with a wide range of email services including Maileroo, Gmail, Outlook.com, Office 365, Yahoo, and more.
...
= Are there plans to add new features to WP Easy SMTP by Maileroo? =

We're always open to suggestions! If there's a feature you'd like to see in WP Easy SMTP by Maileroo, please let us know. While we can't promise to implement every request, we seriously consider all feasible and sensible suggestions to enhance our plugin.

== Screenshots ==

1. ![Desktop Screenshot](https://maileroo.com/media/plugins/wp-easy-smtp-desktop-view.png)
2. ![Mobile Screenshot](https://maileroo.com/media/plugins/wp-easy-smtp-mobile-view.png)
